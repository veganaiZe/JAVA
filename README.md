...
<summary>JDK 8 <i>(LTS - 12/2030)</i></summary>
  ...
  - [_Features_](https://openjdk.org/projects/jdk8/features) _/_ [_What's New_](https://www.oracle.com/java/technologies/javase/8-whats-new.html)
    ...
    - [javafx 8](https://pixelduke.wordpress.com/2013/08/22/whats-new-in-java-8-part-i-javafx/) (_removed in oracle jdk 8u451_)
...
<summary>JDK 11 <i>(LTS - <del>09/2026</del> 01/2032)</i></summary>
  ...
  - [_Features_](https://openjdk.org/projects/jdk/11/)
    ...
    - [http client](https://openjdk.org/jeps/321) ([intro](https://openjdk.org/groups/net/httpclient/intro.html)) ([api](https://docs.oracle.com/en/java/javase/11/docs/api/java.net.http/java/net/http/package-summary.html)) ([examples](https://openjdk.org/groups/net/httpclient/recipes.html))
